...
const ADMIN_EMAILS = [
  "oeffentlichkeitsarbeit@dzkb.bayern",
  "mitgliederverwaltung@dzkb.bayern",
]
const SENDER_EMAIL = "info@fuehrerschein.dzkb.bayern"
const APP_URL =
  Deno.env.get("APP_URL") || "https://event-manager-nu-bay.vercel.app"
...
serve(async (req) => {
  ...
  try {
    ...
    if (!record || !record.title) {
      throw new Error("Ungültige Event-Daten")
    }
